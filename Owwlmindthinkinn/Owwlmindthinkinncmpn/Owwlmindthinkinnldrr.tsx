...
<head>
  ...
  <style>
    ...
    .loader-inner ul li:nth-child(2) {
      --c: var(--page-fold);
      animation-name: page-2;
    }

    .loader-inner ul li:nth-child(3) {
      --c: var(--page-fold);
      animation-name: page-3;
    }

    .loader-inner ul li:nth-child(4) {
      --c: var(--page-fold);
      animation-name: page-4;
    }

    .loader-inner ul li:nth-child(5) {
      --c: var(--page-fold);
      animation-name: page-5;
    }

    .loader-inner ul li svg {
      width: 90px;
      height: 120px;
      display: block;
    }

    .loader-inner ul li:first-child {
      --r: 0deg;
      --o: 1;
    }

    .loader-inner ul li:last-child {
      --o: 1;
    }
